...
const projects = [
  {
    title: "Flipkart 2.0",
    cardImage: "assets/images/project-page/flipkart_logo.png",
    description: "Flipkart 2.0 is a clone of Flipkart.",
    tagimg: "",
    Previewlink: "",
    Githublink: "https://github.com/NandanNNP/flipcart2.0",
  },
  {
    title: "Plan Makers",
    cardImage: "assets/images/project-page/Planmakers_logo.png",
    description: "Plan Makers prepares building plans based on user requirements and collects fees for issuing the plan.",
    tagimg: "",
    Previewlink: "",
    Githublink: "https://github.com/NandanNNP/plan-makers",
  },
  {
    title: "Responsible CV",
    cardImage: "assets/images/project-page/cv_logo.jpg",
    description: "Responsible CV is a html form of CV",
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "https://nandannnp.github.io/Responsible-CV/",
    Githublink: "https://github.com/NandanNNP/Responsible-CV",
  },
  // {
        ...
        <div class="column skill-card card" style="margin: 15px"data-aos="zoom-in-up" data-aos-easing="linear" data-aos-delay="300" data-aos-duration="600" >
          <div class="wrapper" style="background: url(${cardImage}) center / cover no-repeat;">
            ...
            <div class="data">
              <div class="content">
              <div class="title-div">
                <h1 class="title">${title}</h1>      <!-- <h1 class="title"><a href="#">${title}</a></h1> -->
                </div>
